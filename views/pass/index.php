...
/*echo '/vendor/eo/passbook/www/router.php';
die;*/

//echo __DIR__;
/*echo \Yii::getAlias('@webroot');

require_once \Yii::getAlias('@webroot').'D:/OpenServer/domains/lip/vendor/eo/passbook/www/router.php';*/
...
//$dir = './passes/';
$dir = './passes/';
//echo dirname(__DIR__.'/www/passes'); die;
